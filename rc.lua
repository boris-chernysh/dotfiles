...
globalkeys = awful.util.table.join(
	...
	awful.key({ }, "#107", function () awful.util.spawn("amixer set Master unmute") end),
	awful.key({}, "#78", function () awful.util.spawn("amixer set Master 5%-") end),
	awful.key({}, "#127", function () awful.util.spawn("amixer set Master 5%+") end),
